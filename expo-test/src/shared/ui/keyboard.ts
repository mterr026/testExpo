export const purchaseAmountAccessoryId = "purchase-amount-accessory";
export const billAmountAccessoryId = "bill-amount-accessory";
export const billEntryAmountAccessoryId = "bill-entry-amount-accessory";
